...
async def main():
    ...
    price_stream = PriceStream(event_bus, symbol="SOLUSDC")               # récupère les prix 
    
    candel_snapshot_history = CandleSnapShotHistory(event_bus, symbol="SOLUSDC", period=timedelta(minutes=5), history_limit=100)
