...
if __name__ == "__main__":
    ...
    # Logger.set_level("MovingAverage", logging.DEBUG)
    # Logger.set_level("PriceCrossEmaSignalEngine", logging.DEBUG)
    # Logger.set_level("PriceCrossSystemTrading", logging.DEBUG)
    ...
    backtest_executor = Backtest("price_cross_ema_bot")
